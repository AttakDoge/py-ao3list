...
the plan is to make this a package
...
with that metadata, it will also store the work id and the last chapter read (although the user has to give that manually, i'm not making a tool that snoops on your browser)
...
if you have a problem with my work here (or don't), feel free to contact me: [liambragg1@gmail.com](mailto:liambragg1+github@gmail.com)